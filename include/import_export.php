...
class ashu_option_import_class {
      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            <p>
              <form enctype="multipart/form-data" method="post" action="<?php echo menu_page_url( 'ashupw_import', 0 ); ?>">
        ...
        <tr>
          ...
          <td>
            ...
            <p>
              <form method="post" action="<?php echo menu_page_url( 'ashupw_import', 0 ); ?>">
              <?php
  ...
  function import() {
      ...
      update_option( 'ashu_'.$key, $settings );
		}
